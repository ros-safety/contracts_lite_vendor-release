## contracts_lite_vendor (foxy) - 0.4.1-1

The packages in the `contracts_lite_vendor` repository were released into the `foxy` distro by running `/usr/bin/bloom-release --track foxy --ros-distro foxy contracts_lite_vendor` on `Mon, 26 Oct 2020 13:32:15 -0000`
...
## contracts_lite_vendor (dashing) - 0.4.1-1

The packages in the `contracts_lite_vendor` repository were released into the `dashing` distro by running `/usr/bin/bloom-release --track dashing --ros-distro dashing contracts_lite_vendor` on `Mon, 26 Oct 2020 13:29:09 -0000`
...
## contracts_lite_vendor (foxy) - 0.4.0-1

The packages in the `contracts_lite_vendor` repository were released into the `foxy` distro by running `/usr/bin/bloom-release --track foxy --ros-distro foxy contracts_lite_vendor` on `Tue, 22 Sep 2020 18:28:01 -0000`
...
## contracts_lite_vendor (dashing) - 0.4.0-1

The packages in the `contracts_lite_vendor` repository were released into the `dashing` distro by running `/usr/bin/bloom-release --track dashing --ros-distro dashing contracts_lite_vendor` on `Tue, 22 Sep 2020 18:24:40 -0000`
